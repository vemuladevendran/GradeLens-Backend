...
class Grader:
    ...
    def __init__(self, rubric_path, context_path, question, minimum_word_count, overall_score, strictness = 1):
        ...
        self.context = get_relevant_chunks(os.path.join(os.path.dirname(BASEDIR), context_path), question)
